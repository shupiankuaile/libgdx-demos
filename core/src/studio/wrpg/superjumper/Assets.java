...
public class Assets {
	...
	public static void load () {
		background = loadTexture("superjumper_data/background.png");
		backgroundRegion = new TextureRegion(background, 0, 0, 320, 480);

		items = loadTexture("superjumper_data/items.png");
		...
		font = new BitmapFont(Gdx.files.internal("superjumper_data/font.fnt"), Gdx.files.internal("superjumper_data/font.png"), false);

		music = Gdx.audio.newMusic(Gdx.files.internal("superjumper_data/music.mp3"));
		music.setLooping(true);
		music.setVolume(0.5f);
		if (Settings.soundEnabled) music.play();
		jumpSound = Gdx.audio.newSound(Gdx.files.internal("superjumper_data/jump.wav"));
		highJumpSound = Gdx.audio.newSound(Gdx.files.internal("superjumper_data/highjump.wav"));
		hitSound = Gdx.audio.newSound(Gdx.files.internal("superjumper_data/hit.wav"));
		coinSound = Gdx.audio.newSound(Gdx.files.internal("superjumper_data/coin.wav"));
		clickSound = Gdx.audio.newSound(Gdx.files.internal("superjumper_data/click.wav"));
	}
